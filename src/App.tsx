                ...
                <AnimatePresence mode="wait">
                  {currentQuestion && !isGenerating && (
                    ...
                    >
                      ...
                      <div className="p-6 rounded-xl bg-gradient-to-br from-primary/15 via-accent/10 to-secondary/15 border-2 border-primary/30 max-h-[50vh] overflow-y-auto" tabIndex={0}>
